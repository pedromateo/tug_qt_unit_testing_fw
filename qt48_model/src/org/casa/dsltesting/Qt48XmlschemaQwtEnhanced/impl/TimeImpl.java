 ...
 * <ul>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.TimeImpl#getHour <em>Hour</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.TimeImpl#getMinute <em>Minute</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.TimeImpl#getSecond <em>Second</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeImpl extends MinimalEObjectImpl.Container implements Time {
	...
	protected EClass eStaticClass() {
		return Qt48XmlschemaQwtEnhancedPackage.Literals.TIME;
	}
	...
	public void setHour(BigInteger newHour) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.TIME__HOUR, oldHour, hour));
	}
	...
	public void setMinute(BigInteger newMinute) {
		...
		minute = newMinute;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.TIME__MINUTE, oldMinute, minute));
	}
	...
	public void setSecond(BigInteger newSecond) {
		...
		second = newSecond;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.TIME__SECOND, oldSecond, second));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaQwtEnhancedPackage.TIME__HOUR:
				return getHour();
			case Qt48XmlschemaQwtEnhancedPackage.TIME__MINUTE:
				return getMinute();
			case Qt48XmlschemaQwtEnhancedPackage.TIME__SECOND:
				return getSecond();
		}
