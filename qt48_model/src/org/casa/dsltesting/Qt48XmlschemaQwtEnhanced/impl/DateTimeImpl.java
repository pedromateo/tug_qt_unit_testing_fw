 ...
 * <ul>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.DateTimeImpl#getHour <em>Hour</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.DateTimeImpl#getMinute <em>Minute</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.DateTimeImpl#getSecond <em>Second</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.DateTimeImpl#getYear <em>Year</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.DateTimeImpl#getMonth <em>Month</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.DateTimeImpl#getDay <em>Day</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DateTimeImpl extends MinimalEObjectImpl.Container implements DateTime {
	...
	protected EClass eStaticClass() {
		return Qt48XmlschemaQwtEnhancedPackage.Literals.DATE_TIME;
	}
	...
	public void setHour(BigInteger newHour) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__HOUR, oldHour, hour));
	}
	...
	public void setMinute(BigInteger newMinute) {
		...
		minute = newMinute;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__MINUTE, oldMinute, minute));
	}
	...
	public void setSecond(BigInteger newSecond) {
		...
		second = newSecond;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__SECOND, oldSecond, second));
	}
	...
	public void setYear(BigInteger newYear) {
		...
		year = newYear;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__YEAR, oldYear, year));
	}
	...
	public void setMonth(BigInteger newMonth) {
		...
		month = newMonth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__MONTH, oldMonth, month));
	}
	...
	public void setDay(BigInteger newDay) {
		...
		day = newDay;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__DAY, oldDay, day));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__HOUR:
				return getHour();
			case Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__MINUTE:
				return getMinute();
			case Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__SECOND:
				return getSecond();
			case Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__YEAR:
				return getYear();
			case Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__MONTH:
				return getMonth();
			case Qt48XmlschemaQwtEnhancedPackage.DATE_TIME__DAY:
				return getDay();
		}
