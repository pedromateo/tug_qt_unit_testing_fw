 ...
 * </p>
 * <ul>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.LayoutDefaultImpl#getMargin <em>Margin</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.LayoutDefaultImpl#getSpacing <em>Spacing</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LayoutDefaultImpl extends MinimalEObjectImpl.Container implements LayoutDefault {
	/**
	...
	protected EClass eStaticClass() {
		return Qt48XmlschemaQwtEnhancedPackage.Literals.LAYOUT_DEFAULT;
	}
	...
	public void setMargin(BigInteger newMargin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.LAYOUT_DEFAULT__MARGIN, oldMargin, margin));
	}
	...
	public void setSpacing(BigInteger newSpacing) {
		...
		spacing = newSpacing;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.LAYOUT_DEFAULT__SPACING, oldSpacing, spacing));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaQwtEnhancedPackage.LAYOUT_DEFAULT__MARGIN:
				return getMargin();
			case Qt48XmlschemaQwtEnhancedPackage.LAYOUT_DEFAULT__SPACING:
				return getSpacing();
		}
