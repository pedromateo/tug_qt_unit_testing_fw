 ...
 * </p>
 * <ul>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.CharImpl#getUnicode <em>Unicode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharImpl extends MinimalEObjectImpl.Container implements Char {
	...
	protected EClass eStaticClass() {
		return Qt48XmlschemaQwtEnhancedPackage.Literals.CHAR;
	}
	...
	public void setUnicode(BigInteger newUnicode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.CHAR__UNICODE, oldUnicode, unicode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaQwtEnhancedPackage.CHAR__UNICODE:
				return getUnicode();
		}
