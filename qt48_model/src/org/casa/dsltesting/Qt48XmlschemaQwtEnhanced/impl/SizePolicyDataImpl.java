 ...
 * </p>
 * <ul>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.SizePolicyDataImpl#getHordata <em>Hordata</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48XmlschemaQwtEnhanced.impl.SizePolicyDataImpl#getVerdata <em>Verdata</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SizePolicyDataImpl extends MinimalEObjectImpl.Container implements SizePolicyData {
	...
	protected EClass eStaticClass() {
		return Qt48XmlschemaQwtEnhancedPackage.Literals.SIZE_POLICY_DATA;
	}
	...
	public void setHordata(BigInteger newHordata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.SIZE_POLICY_DATA__HORDATA, oldHordata, hordata));
	}
	...
	public void setVerdata(BigInteger newVerdata) {
		...
		verdata = newVerdata;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.SIZE_POLICY_DATA__VERDATA, oldVerdata, verdata));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaQwtEnhancedPackage.SIZE_POLICY_DATA__HORDATA:
				return getHordata();
			case Qt48XmlschemaQwtEnhancedPackage.SIZE_POLICY_DATA__VERDATA:
				return getVerdata();
		}
