...
public class DateImpl extends MinimalEObjectImpl.Container implements Date {
	...
	protected EClass eStaticClass() {
		return Qt48XmlschemaQwtEnhancedPackage.Literals.DATE;
	}
	...
	public void setYear(BigInteger newYear) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.DATE__YEAR, oldYear, year));
	}
	...
	public void setMonth(BigInteger newMonth) {
		...
		month = newMonth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.DATE__MONTH, oldMonth, month));
	}
	...
	public void setDay(BigInteger newDay) {
		...
		day = newDay;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaQwtEnhancedPackage.DATE__DAY, oldDay, day));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaQwtEnhancedPackage.DATE__YEAR:
				return getYear();
			case Qt48XmlschemaQwtEnhancedPackage.DATE__MONTH:
				return getMonth();
			case Qt48XmlschemaQwtEnhancedPackage.DATE__DAY:
				return getDay();
		}
