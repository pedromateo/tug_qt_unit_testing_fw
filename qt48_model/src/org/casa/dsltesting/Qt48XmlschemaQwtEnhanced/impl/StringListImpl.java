...
public class StringListImpl extends MinimalEObjectImpl.Container implements StringList {
	...
	protected EClass eStaticClass() {
		return Qt48XmlschemaQwtEnhancedPackage.Literals.STRING_LIST;
	}
	...
	public EList<String> getString() {
		if (string == null) {
			string = new EDataTypeEList<String>(String.class, this, Qt48XmlschemaQwtEnhancedPackage.STRING_LIST__STRING);
		}
		return string;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaQwtEnhancedPackage.STRING_LIST__STRING:
				return getString();
		}
