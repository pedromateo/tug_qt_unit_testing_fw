 ...
 *   <li>{@link org.casa.dsltesting.Qt48Xmlschema.impl.LayoutItemImpl#getSpacer <em>Spacer</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48Xmlschema.impl.LayoutItemImpl#getAlignment <em>Alignment</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48Xmlschema.impl.LayoutItemImpl#getColspan <em>Colspan</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48Xmlschema.impl.LayoutItemImpl#getColumn <em>Column</em>}</li>
...
public class LayoutItemImpl extends MinimalEObjectImpl.Container implements LayoutItem {
	...
	public NotificationChain basicSetWidget(Widget newWidget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__WIDGET, oldWidget, newWidget);
	...
	public void setWidget(Widget newWidget) {
		if (newWidget != widget) {
			...
			if (widget != null)
				msgs = ((InternalEObject)widget).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Qt48XmlschemaPackage.LAYOUT_ITEM__WIDGET, null, msgs);
			if (newWidget != null)
				msgs = ((InternalEObject)newWidget).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Qt48XmlschemaPackage.LAYOUT_ITEM__WIDGET, null, msgs);
			msgs = basicSetWidget(newWidget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__WIDGET, newWidget, newWidget));
	}
	...
	public NotificationChain basicSetLayout(Layout newLayout, NotificationChain msgs) {
		...
		layout = newLayout;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__LAYOUT, oldLayout, newLayout);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLayout(Layout newLayout) {
		if (newLayout != layout) {
			NotificationChain msgs = null;
			if (layout != null)
				msgs = ((InternalEObject)layout).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Qt48XmlschemaPackage.LAYOUT_ITEM__LAYOUT, null, msgs);
			if (newLayout != null)
				msgs = ((InternalEObject)newLayout).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Qt48XmlschemaPackage.LAYOUT_ITEM__LAYOUT, null, msgs);
			msgs = basicSetLayout(newLayout, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__LAYOUT, newLayout, newLayout));
	}
	...
	public NotificationChain basicSetSpacer(Spacer newSpacer, NotificationChain msgs) {
		...
		spacer = newSpacer;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__SPACER, oldSpacer, newSpacer);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSpacer(Spacer newSpacer) {
		if (newSpacer != spacer) {
			NotificationChain msgs = null;
			if (spacer != null)
				msgs = ((InternalEObject)spacer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Qt48XmlschemaPackage.LAYOUT_ITEM__SPACER, null, msgs);
			if (newSpacer != null)
				msgs = ((InternalEObject)newSpacer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Qt48XmlschemaPackage.LAYOUT_ITEM__SPACER, null, msgs);
			msgs = basicSetSpacer(newSpacer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__SPACER, newSpacer, newSpacer));
	}
	...
	public void setAlignment(String newAlignment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__ALIGNMENT, oldAlignment, alignment));
	}
	...
	public void setColspan(BigInteger newColspan) {
		...
		colspan = newColspan;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__COLSPAN, oldColspan, colspan));
	}
	...
	public void setColumn(BigInteger newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__COLUMN, oldColumn, column));
	}
	...
	public void setRow(BigInteger newRow) {
		...
		row = newRow;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__ROW, oldRow, row));
	}
	...
	public void setRowspan(BigInteger newRowspan) {
		...
		rowspan = newRowspan;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.LAYOUT_ITEM__ROWSPAN, oldRowspan, rowspan));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Qt48XmlschemaPackage.LAYOUT_ITEM__LAYOUT:
				return basicSetLayout(null, msgs);
			case Qt48XmlschemaPackage.LAYOUT_ITEM__SPACER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Qt48XmlschemaPackage.LAYOUT_ITEM__SPACER:
				return getSpacer();
			case Qt48XmlschemaPackage.LAYOUT_ITEM__ALIGNMENT:
				return getAlignment();
			case Qt48XmlschemaPackage.LAYOUT_ITEM__COLSPAN:
				return getColspan();
			case Qt48XmlschemaPackage.LAYOUT_ITEM__COLUMN:
				return getColumn();
			case Qt48XmlschemaPackage.LAYOUT_ITEM__ROW:
				return getRow();
			case Qt48XmlschemaPackage.LAYOUT_ITEM__ROWSPAN:
				return getRowspan();
		}
