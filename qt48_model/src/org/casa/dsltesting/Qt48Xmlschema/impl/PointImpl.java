...
public class PointImpl extends EObjectImpl implements Point {
	...
	public void setX(BigInteger newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.POINT__X, oldX, x));
	}
	...
	public void setY(BigInteger newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.POINT__Y, oldY, y));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaPackage.POINT__X:
				return getX();
			case Qt48XmlschemaPackage.POINT__Y:
				return getY();
		}
