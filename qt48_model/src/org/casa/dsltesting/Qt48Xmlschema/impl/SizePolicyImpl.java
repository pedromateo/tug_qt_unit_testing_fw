 ...
 *   <li>{@link org.casa.dsltesting.Qt48Xmlschema.impl.SizePolicyImpl#getHorstretch <em>Horstretch</em>}</li>
 *   <li>{@link org.casa.dsltesting.Qt48Xmlschema.impl.SizePolicyImpl#getVerstretch <em>Verstretch</em>}</li>
...
public class SizePolicyImpl extends EObjectImpl implements SizePolicy {
	...
	public void setHsizetype(BigInteger newHsizetype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.SIZE_POLICY__HSIZETYPE, oldHsizetype, hsizetype));
	}
	...
	public void setVsizetype(BigInteger newVsizetype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.SIZE_POLICY__VSIZETYPE, oldVsizetype, vsizetype));
	}
	...
	public void setHorstretch(BigInteger newHorstretch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.SIZE_POLICY__HORSTRETCH, oldHorstretch, horstretch));
	}
	...
	public void setVerstretch(BigInteger newVerstretch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.SIZE_POLICY__VERSTRETCH, oldVerstretch, verstretch));
	}
	...
	public void setHsizetype1(String newHsizetype1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.SIZE_POLICY__HSIZETYPE1, oldHsizetype1, hsizetype1));
	}
	...
	public void setVsizetype1(String newVsizetype1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.SIZE_POLICY__VSIZETYPE1, oldVsizetype1, vsizetype1));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaPackage.SIZE_POLICY__HSIZETYPE:
				return getHsizetype();
			case Qt48XmlschemaPackage.SIZE_POLICY__VSIZETYPE:
				return getVsizetype();
			case Qt48XmlschemaPackage.SIZE_POLICY__HORSTRETCH:
				return getHorstretch();
			case Qt48XmlschemaPackage.SIZE_POLICY__VERSTRETCH:
				return getVerstretch();
			case Qt48XmlschemaPackage.SIZE_POLICY__HSIZETYPE1:
				return getHsizetype1();
			case Qt48XmlschemaPackage.SIZE_POLICY__VSIZETYPE1:
