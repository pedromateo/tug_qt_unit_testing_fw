...
public class ButtonGroupImpl extends EObjectImpl implements ButtonGroup {
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, Qt48XmlschemaPackage.BUTTON_GROUP__GROUP);
		}
		return group;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.BUTTON_GROUP__NAME, oldName, name));
	}
