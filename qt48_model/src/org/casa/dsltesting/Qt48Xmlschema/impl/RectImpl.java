...
public class RectImpl extends MinimalEObjectImpl.Container implements Rect {
	...
	public void setX(BigInteger newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.RECT__X, oldX, x));
	}
	...
	public void setY(BigInteger newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.RECT__Y, oldY, y));
	}
	...
	public void setWidth(BigInteger newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.RECT__WIDTH, oldWidth, width));
	}
	...
	public void setHeight(BigInteger newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Qt48XmlschemaPackage.RECT__HEIGHT, oldHeight, height));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Qt48XmlschemaPackage.RECT__X:
				return getX();
			case Qt48XmlschemaPackage.RECT__Y:
				return getY();
			case Qt48XmlschemaPackage.RECT__WIDTH:
				return getWidth();
			case Qt48XmlschemaPackage.RECT__HEIGHT:
				return getHeight();
		}
